...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: `http://localhost:4040/restaurant/${restaurant}`,
            method: 'GET',
    ...
    handleOrder = () => {
        ...
        axios({
            url: `http://localhost:4040/menuitems/${restId}`,
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        })
            .then(res => {
    ...
    getData = (data) => {
        return fetch(`http://localhost:4040/payment`, {
            method: "POST",
            headers: {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="heading1">{restaurant.name}</div>
                ...
                >
                    <div>
                        ...
                        <button className="btn btn-danger" style={{ float: 'right', marginTop: '6px' }} onClick={this.Payments}>Proceed</button>
                    </div>
                </Modal>
